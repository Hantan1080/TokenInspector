// src/lib.rs
/*
 * Core library for TokenInspector
 */
...
#[derive(Debug)]
pub struct TokenInspectorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenInspectorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenInspector processing");
    
    let mut processor = TokenInspectorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenInspectorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenInspectorProcessor::new(false);
